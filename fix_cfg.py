...
for i, cell in enumerate(nb['cells']):
    ...
    if 'write_botsort_cfg' in src and 'tracker_type' in src:
        ...
        cell['source'] = [
            ...
            "        'with_reid': with_reid,\n",
            "        # Do NOT include 'model' key — Ultralytics tries to open it as a file\n",
            "        # and raises FileNotFoundError. The built-in ReID model is loaded\n",
            "        # internally by Ultralytics when with_reid=True; no path needed.\n",
            "    }\n",
